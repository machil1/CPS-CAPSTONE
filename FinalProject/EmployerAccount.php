...
<body>
  ...
  <div class="tab-content">
    <div class="tab-pane fade" id="accHome" role="tabpanel">
      ...
      echo "<h1>Company Information</h1><br>";
      echo "<b>Email Address:</b> $Email<br>";
      echo "<b>Address:</b> <br>";
      echo "<b>Phone Number:</b> $PhoneNum";
      ?>
      <br>
      <hr>
      <br>
    ...
    <center><button class = "btn btn-success" id ="composeBtn" onclick="messag()">Compose Message</button></center>
        ...
        <b><h2>Hiring Quesiton</h2></b>
        <p>Test,<br>
            Will you be able to start remotely starting 7/1/2020.<br>
            Please respond within 2 business days for confirmation. <br>
          Best,<br>
            CyberHire
        </p>
        <p><button class = "btn btn-success">Respond</button> <button class = "btn btn-success">Delete</button></p>
        <hr>
        <b><h2>Question on professional experience</h2></b>
        <p>John, <br>
            On your resume it says that you have PHP related experience, <br>
            can you elaborate on that for the role of Software Developer. <br>
          Best,<br>
            CyberHire
        </p>
        <p><button class = "btn btn-success">Respond</button> <button class = "btn btn-success">Delete</button></p>
